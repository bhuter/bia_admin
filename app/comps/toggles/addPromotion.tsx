...
const AddPromotion: React.FC<{ onClose: () => void }> = ({ onClose }) => {
      ...
      <div className="max-w-2xl w-full rounded-xl px-6 py-3 bg-white border shadow-md">
        ...
        <form className="my-2" autoComplete="off" onSubmit={handleSubmit}>
          <div className="flex flex-col w-full mb-3">
            <label className="text-sm font-semibold" htmlFor="promotionType">
              Promotion Type
            </label>
            <select
              name="promotionType"
          ...
          <div className="flex flex-col w-full mb-3">
            <label className="text-sm font-semibold" htmlFor="promotion">
              Promotion Details
            </label>
            <input
              type="number"
              name="promotion"
              className="px-4 py-2 border text-sm border-slate-300 my-1"
              placeholder="Enter promotion number in percentage (%)"
